	...
	{$.fn.buzinaPagination=function(options)
		{
			...
			var pagerDom=createPagerDom(pagesTotal,pagerId,settings,currentActiveNumber);
					...
					if(pageClicked==settings.prevText)
						...
						if(pageClicked==settings.nextText)
						{
						...
						else
							{
								...
								console.log('3 page '+ currentActiveNumber);
							}
					}
				)
		}
...
function createPagerDom(pagesTotal,pagerId,settings,currentActiveNumber)
	{	var pagerConc="";
		for(i=0;i<pagesTotal;i++)
			{
				if (i===currentActiveNumber)
				{
								pagerConc+=`
