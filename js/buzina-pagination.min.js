...
(function($)
	{$.fn.buzinaPagination=function(options)
		{
			var settings=$.extend({prevnext:!0,prevText:"Назад",nextText:"Вперед",itemsOnPage:1},options);
			...
			for(i=0;i<pagesTotal;i++)
				{$("#"+buzinaContentId+"> div").slice(i,i+settings.itemsOnPage).wrapAll("<div />");
					buzinaContent.children(":eq("+i+")").addClass(pageClass+(i+1)+" content-page")
				  buzinaContent.children(":eq("+i+")").wrapInner("<div class='row' />")
			...
			var pagerDom=createPagerDom(pagesTotal,pagerId,settings,currPage);
							...
							if(currentActiveNumber>1)
								{
								  ...
								  $(".page-item.page"+(parseInt(currentActiveNumber)-2)).addClass("active")
									
									console.log('1 page '+ currentActiveNumber);
								}
						}
					else 
						if(pageClicked==settings.nextText)
						{
							var currentActive=$(".content-page-active").attr("class");
							var currentActiveNumber=currentActive.substring(currentActive.indexOf("--page")+7,currentActive.indexOf(" "));
							if(currentActiveNumber<pagesTotal)
								{
									...
									$(".page-item").removeClass("active");
								  $(".page-item.page"+(parseInt(currentActiveNumber))).addClass("active")
									
									console.log('2 page '+ currentActiveNumber);
								}
						}
						else
							{
								...
								$(".page-item").removeClass("active");
								$(".page-item.page"+(parseInt(pageClicked)-1)).addClass("active")
								
								console.log('3 page '+ pageClicked);
							}
					}
				)
		}
...
function createPagerDom(pagesTotal,pagerId,settings,currPage)
	{	var pagerConc="";
		for(i=0;i<pagesTotal;i++)
			{
				if(i===currPage)
